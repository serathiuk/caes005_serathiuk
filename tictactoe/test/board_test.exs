defmodule BoardTest do
  ...
  test "test new board" do
    assert Board.new() == %Board{board: [:e, :e, :e, :e, :e, :e, :e, :e, :e]}
  end

  test "test execute single command for x" do
    assert Board.execute_command(Board.new(), Command.new(:x, 2, 2)) == %Board{board: [:e, :e, :e, :e, :x, :e, :e, :e, :e], last_player: :x}
  end
  ...
  test "test execute multiple commands" do
    ...
    |> Board.execute_command(Command.new(:x, 3, 3)) == %Board{board: [:x, :o, :x, :o, :x, :o, :x, :o, :x], last_player: :x}
  end
